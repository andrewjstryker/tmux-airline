...
_airline_description () {
  case "$1" in
    ...
    palette\ describe) printf %s Describe\ catalog\ metadata\,\ options\,\ and\ resolved\ path ;;
    ...
    layout\ describe) printf %s Describe\ catalog\ metadata\,\ options\,\ and\ resolved\ path ;;
