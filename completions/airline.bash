...
_airline_children () {
  case "$1" in
    ...
    palette) printf %s describe\ show\ use\ list\ register ;;
...
_airline_description () {
  case "$1" in
    ...
    palette\ describe) printf %s Describe\ catalog\ metadata\ and\ resolved\ path ;;
    ...
    adapter\ describe) printf %s Describe\ catalog\ metadata\ and\ resolved\ path ;;
    ...
    layout\ describe) printf %s Describe\ catalog\ metadata\ and\ resolved\ path ;;
    ...
    classifier\ describe) printf %s Describe\ summary\ and\ resolved\ path ;;
    ...
    filter\ describe) printf %s Describe\ summary\ and\ resolved\ path ;;
    filter\ list) printf %s List\ filters\ available\ to\ runners ;;
    filter\ register) printf %s Add\ a\ filter\ search\ directory ;;
    probe\ describe) printf %s Describe\ summary\,\ arguments\,\ interval\,\ and\ resolved\ path ;;
